...
public class WaveLoadingView extends View {
	...
	mBorderPaint.setStrokeWidth(attributes.getDimension(R.styleable.WaveLoadingView_mlv_borderWidth,
	...
	mTopTitlePaint.setTextSize(attributes.getDimension(R.styleable.WaveLoadingView_mlv_titleTopSize,
	...
	mCenterTitlePaint.setTextSize(attributes.getDimension(R.styleable.WaveLoadingView_mlv_titleCenterSize,
	...
	mBottomTitlePaint.setTextSize(attributes.getDimension(R.styleable.WaveLoadingView_mlv_titleBottomSize,
	...
	if (mWaveShader != null) {
	    ...
	    case 1:
		if (borderWidth > 0) {
		    canvas.drawRect(borderWidth / 2f, borderWidth / 2f, getWidth() - borderWidth / 2f - 0.5f, getHeight()
			    - borderWidth / 2f - 0.5f, mBorderPaint);
		}
		...
		canvas.drawText(mBottomTitle, (getWidth() - bottom) / 2, getHeight() * 8 / 10.0f
